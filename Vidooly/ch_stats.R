...
#ch_stats
#ChannelID=UC6_aLZwre0yxXvhwNw
#We filtered the given data to get data for specified channelid
#and saved it in octmar2.csv
octmar=read.csv('F:/R_in_Action/Vidooly/octmar2.csv',stringsAsFactors = FALSE)
str(octmar)
...
colSums(is.na(octmar)) #Checking NA values
library(xts)
library(zoo)
...
#We export the 3 predicted values into a csv file, alongwith the channelid and date using write.csv function
